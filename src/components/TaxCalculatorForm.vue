    ...
    <Card class="calc-card" :class="{ 'calc-card-expanded': compareMode }">
        ...
        <template #content>
            <form @submit.prevent="handleSubmit" class="form-content">
                ...
                <MunicipalitySelect v-model="municipalityId"
                ...
                <template v-if="compareMode">
                    ...
                    <div class="compare-section">
                        ...
                        <RegionSelect v-model="compareRegionId"
                                      :disabled="hasResult"
                                      placeholder="Sök region..."
                                      aria-label="Välj region för jämförelse" />
                        <MunicipalitySelect v-model="compareMunicipalityId"
                ...
                <Button v-if="!hasResult"
                        type="submit"
                        label="Beräkna nettoinkomst"
                        :loading="loading"
                        :outlined="!isValid"
                        class="submit-btn" />
                <Button v-else
                        type="button"
                        label="Beräkna ny nettoinkomst"
                        @click="handleReset"
                        class="submit-btn" />
            </form>
        </template>
